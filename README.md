...
* Regulatory function of RV-associated chromosome 2 locus:
  ...
  2. Script (LIMS1_cytokine_correlation.R) and data (IFN_monocytes_cytokine.txt) to reproduce correlation between LIMS1 expression and secretin of HGF from stimulated (IFN-gamma 24 hours) monocytes.
