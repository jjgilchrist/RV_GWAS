...
#read in summary statistics: GWAS of hospitalised RV disease risk in Kenya
#summary statistics are randomly thinned (1 in 10) with the exception of secretor status region
...
#need to highlight secretor locus
...
#plot manhattan plot
kenya.manh <- ggplot(disc.add2, aes(x=BPcum, y=-log10(p))) +
